...
export default function EditEventPage() {
  ...
  const [defaultValues, setDefaultValues] = useState<EventFormValues | null>(null);
  ...
  // Set default values for edit mode (empty for now since we don't have detail API)
  useEffect(() => {
    setDefaultValues({
      oratorId: "",
      eventName: "",
  ...
  const handleSubmit = async (data: EventFormValues) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(responseData.message || "Failed to update event");
      }
    } catch {
